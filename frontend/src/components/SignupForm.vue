    ...
    <div class="row">
      <div class="col-12 form-group">
        ...
        <input
          ...
          :class="{ 'is-invalid': validationStatus($v.nom) }"
          class="form-control form-control-lg"
        />
        <div v-if="!$v.nom.required" class="invalid-feedback">
      ...
      <div class="col-12 form-group">
        ...
        <input
          ...
          :class="{ 'is-invalid': validationStatus($v.prenom) }"
          class="form-control form-control-lg"
        />
        <div v-if="!$v.prenom.required" class="invalid-feedback">
          The full name field is required.
        </div>
      </div>
      ...
      <div class="col-12 form-group">
        ...
        <input
          ...
          :class="{ 'is-invalid': validationStatus($v.adresse) }"
          class="form-control form-control-lg"
        />
        <div v-if="!$v.adresse.required" class="invalid-feedback">
          The full name field is required.
        </div>
      </div>
      ...
      <div class="col-12 form-group">
        ...
        <input
          ...
          class="form-control form-control-lg"
        />
        <div v-if="!$v.codepostal.required" class="invalid-feedback">
          The full name field is required.
        </div>
      </div>
      ...
      <div class="col-12 form-group">
        ...
        <input
          ...
          :class="{ 'is-invalid': validationStatus($v.ville) }"
          class="form-control form-control-lg"
        />
        <div v-if="!$v.ville.required" class="invalid-feedback">
          The full name field is required.
        </div>
      </div>
      ...
      <div class="col-12 form-group">
        <label class="col-form-label col-form-label-lg"> Pays <span class="text-danger">*</span></label>
        ...
        <div v-if="!$v.country.required" class="invalid-feedback">The country field is required.
        </div>
      </div>
